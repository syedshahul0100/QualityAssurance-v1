...
function About(){
    ...
    const contactSubmit=()=>{
        alert("Detils are submited successfully")
    }
    ...
    return(
        ...
        <div class="flex mb-4">
        <div class="w-1/2 pb-10 bg-gray-400 aboutHeight ">
        </div>
        <div class="w-1/2 bg-gray-500 "></div>
        </div>

       
    <form class="w-full max-w-lg aboutCard">
  ...
  <button onClick={contactSubmit} class=" contactSubBtn bg-transparent hover:bg-orange-500 text-orange-700 font-semibold hover:text-white py-2 px-4 border border-orange-500 hover:border-transparent rounded">
  Submit
</button>
</form>
